...
import com.data.service.chuangService;
...
@Scope("prototype")
@Controller
@RequestMapping("/chuangweiController")
public class chuangController extends BaseManageController{
	
	@Resource
	private chuangService chuangService;
	/**
	 * 入口
	 */
	...
	public Map<String, Object> selectUserInfoList(UserInfoEntity userInfoEntity) throws IOException {
		...
		map.put("total", chuangService.countUserInfo(userInfoEntity));
		map.put("rows", chuangService.listUserInfo(userInfoEntity));
		return map;
	}
	...
	public String openEditPage(ModelMap modelMap,String id) {
		modelMap.put("userInfo", chuangService.getUserInfoById(id));
		return "chuang/userInfoEdit";
	}
	...
	public int insertUserInfo(UserInfoEntity userInfoEntity) throws IOException {
		...
		return chuangService.insertUserInfo(userInfoEntity);
	}
	...
	public long updateUserInfo(UserInfoEntity userInfoEntity) throws IOException {
		SessionManageEntity user = SessionUtil.getSession(request);
		userInfoEntity.setUpdateBy(user.getUserId());
		return chuangService.updateUserInfo(userInfoEntity);
	}
	...
	public long deleteUserInfo(String ids) throws IOException {
		return chuangService.deleteUserInfo(ids);
	}
