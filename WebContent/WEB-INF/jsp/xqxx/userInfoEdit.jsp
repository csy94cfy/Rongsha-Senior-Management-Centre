...
function save(){
	...
	if($.valid()){
		var urlAddress = "xqxxController/updateUserInfo";
		if($('#hidId').val()==""){//新增
			urlAddress = "xqxxController/insertUserInfo";
		}
		//提交保存
		$("#editForm").ajaxSubmit({
			url:urlAddress,
	...
	<div class="modal-body" style="height: 300px;">
		<form id="editForm" class="form-horizontal no-margin">
			...
			<div class="form-group" >
				<label for="realName" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">需求名称</label>
				<div class="col-sm-8 col-xs-8">
					<input id="realName" value="${userInfo.realName}" name="realName" class="form-control" type="text" placeholder="请输入需求名称"/>
				</div>
			</div>
			<div class="form-group" >
				<label for="userPhone" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">需求详细</label>
				<div class="col-sm-8 col-xs-8">
					<input id="userPhone" value="${userInfo.userPhone}" name="userPhone" class="form-control" type="text" placeholder="请输入电需求详细"/>
				</div>
			</div>
			<div class="form-group" >
				<label for="userPhone" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">需求类型</label>
				<div class="col-sm-8 col-xs-8">
					<select class="form-control" id="openid" name="openid">
								<option value="000">请选择</option>
								<option value="物质需求">物质需求</option>
