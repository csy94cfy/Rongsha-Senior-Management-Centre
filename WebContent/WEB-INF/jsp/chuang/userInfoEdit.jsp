...
function save(){
	...
	if($.valid()){
		var urlAddress = "chuangweiController/updateUserInfo";
		if($('#hidId').val()==""){//新增
			urlAddress = "chuangweiController/insertUserInfo";
		}
		//提交保存
		$("#editForm").ajaxSubmit({
			url:urlAddress,
	...
	<div class="modal-body" style="height: 300px;">
		<form id="editForm" class="form-horizontal no-margin">
			...
			<div class="form-group" >
				<label for="realName" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">老人姓名</label>
				<div class="col-sm-8 col-xs-8">
					<input id="realName" value="${userInfo.realName}" name="realName" class="form-control" type="text" placeholder="请输入老人姓名"/>
				</div>
			</div>
			<div class="form-group" >
				<label for="userPhone" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">老人年龄</label>
				<div class="col-sm-8 col-xs-8">
					<input id="userPhone" value="${userInfo.userPhone}" name="userPhone" class="form-control" type="text" placeholder="请输入老人年龄"/>
				</div>
			</div>
			<div class="form-group" >
				<label for="userPhone" class="col-sm-3 col-xs-3 control-label" style="width: 27%;">居住类型</label>
				<div class="col-sm-8 col-xs-8">
